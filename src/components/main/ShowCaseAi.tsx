    ...
    <div className='min-h-screen w-full relative py-30 mb-0 sm:pb-40 bg-[#f8fafc]' id='showcaseai'>
      <div className='relative w-full h-full'>
        ...
        <div className='relative z-10 w-full px-4 sm:px-6 md:px-8 py-12 sm:py-16 md:py-20'>
          <div className='flex flex-col items-center gap-8 sm:gap-10 md:gap-12 max-w-[70rem] mx-auto'>
            <div className='flex flex-col items-center space-y-4'>
            <div className="inline-block mb-4">
            <span className="text-sm text-centerfont-medium text-white border border-purple-700 rounded-full px-4 py-1 shadow-xl">
              AI FEATURE
            </span>
          </div>
