    ...
    <div className='min-h-screen bg-gray-50 py-20 sm:py-24 md:py-30'>
        <div className='max-w-[85rem] mx-auto px-4 sm:px-6 md:px-8'>
            <div className='grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 xl:gap-12'>
                <div className='lg:col-span-5 xl:col-span-5 flex flex-col justify-center space-y-4 sm:space-y-6'>
                    ...
                    <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight'>
                        Comprehensive Tutorial Workflow
                    </h1>
                ...
                <div className='lg:col-span-7 xl:col-span-7'>
                    <div className='w-full h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[80vh] bg-gradient-to-tl from-yellow-300 via-blue-200 to-blue-100 rounded-2xl sm:rounded-3xl shadow-2xl p-4 sm:p-6 md:p-8 relative overflow-hidden'>
