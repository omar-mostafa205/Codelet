...
export default function RecentChats({ recentChats }: RecentChatsProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-purple-100 via-orange-50 to-white text-gray-800 p-8 rounded-3xl shadow-2xl border border-purple-200/50 h-130 overflow-auto w-full">
      {/* Header */}
